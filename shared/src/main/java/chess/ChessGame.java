...
public class ChessGame {
  ...
  /**
   * Determines if the given team is in check. This occurs when the position of the given team's
   * king is in the list of valid moves for the other team.
   *
  ...
  /**
   * Determines if the given team is in checkmate. This occurs when the given team's king IS IN
   * CHECK and the given team has no valid moves.
   *
  ...
  /**
   * Determines if the given team is in stalemate. This occurs when the given team's king is NOT IN
   * CHECK and the given team has no valid moves.
   *
